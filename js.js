...
var apaga = document.querySelector("#ladodireito_apaga");
...
document.getElementById('ladodireito_apaga').innerHTML = '<textarea readonly id="textArea">' + resultadoCripto +
  '</textearea>' + '<button class="button_copiar" id="button_copiar" onclick="copiar()">Copiar</button>'
...
document.getElementById('ladodireito_apaga').innerHTML = '<textarea readonly id="textArea">' + resultDescripto + 
